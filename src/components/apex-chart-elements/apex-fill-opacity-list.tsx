...
export class ApexFillOpacityList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLApexFillOpacityItemElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'apex-fill-opacity-item') ?? []) as Array<HTMLApexFillOpacityItemElement>
