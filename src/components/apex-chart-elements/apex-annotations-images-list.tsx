...
export class ApexAnnotationsImagesList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLImageAnnotationsElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'image-annotations') ?? []) as Array<HTMLImageAnnotationsElement>
