...
export class ApexXAxisCrosshairsFillGradientStopsList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLApexXAxisCrosshairsFillGradientStopsItemElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'apex-x-axis-crosshairs-fill-gradient-stops-item') ?? []) as Array<HTMLApexXAxisCrosshairsFillGradientStopsItemElement>
