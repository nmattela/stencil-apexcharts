...
export class ApexFillGradientStopsList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLApexFillGradientStopsItemElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'apex-fill-gradient-stops-item') ?? []) as Array<HTMLApexFillGradientStopsItemElement>
