...
export class ApexFillGradientOpacityToList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLApexFillGradientOpacityToItemElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'apex-fill-gradient-opacity-to-item') ?? []) as Array<HTMLApexFillGradientOpacityToItemElement>
