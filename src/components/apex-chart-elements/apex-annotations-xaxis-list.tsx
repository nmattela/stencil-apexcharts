...
export class ApexAnnotationsXaxisList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLXAxisAnnotationsElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'x-axis-annotations') ?? []) as Array<HTMLXAxisAnnotationsElement>
