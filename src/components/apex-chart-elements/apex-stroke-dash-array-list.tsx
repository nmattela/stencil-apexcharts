...
export class ApexStrokeDashArrayList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLApexStrokeDashArrayItemElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'apex-stroke-dash-array-item') ?? []) as Array<HTMLApexStrokeDashArrayItemElement>
