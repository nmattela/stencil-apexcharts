...
export class ApexPlotOptionsTreemapColorScale {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const rangesChildren: Array<HTMLApexPlotOptionsTreemapColorScaleRangesListElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'apex-plot-options-treemap-color-scale-ranges-list') ?? []) as Array<HTMLApexPlotOptionsTreemapColorScaleRangesListElement>
