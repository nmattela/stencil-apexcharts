...
export class ApexYAxisLabelsStyleColorsList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLApexYAxisLabelsStyleColorsItemElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'apex-y-axis-labels-style-colors-item') ?? []) as Array<HTMLApexYAxisLabelsStyleColorsItemElement>
