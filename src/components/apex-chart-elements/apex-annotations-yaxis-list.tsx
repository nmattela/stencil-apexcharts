...
export class ApexAnnotationsYaxisList {
    @Element()
    element!: HTMLElement;
    ...
    async updateChildren() {
        const listItems: Array<HTMLYAxisAnnotationsElement> = (this.slotElement?.assignedElements().filter(el => el.tagName.toLowerCase() === 'y-axis-annotations') ?? []) as Array<HTMLYAxisAnnotationsElement>
